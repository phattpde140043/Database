...
df_enriched = df \
    ...
    .withColumn("hash", sha2(concat_ws("||",col("warehouse_id"),col("name"),col("location"),col("created_at"),col("deleted_at"),col("updated_at")), 256)) \
...
df_deduplicated = (df_enriched
                   ...
                   .dropDuplicates(["warehouse_id", "hash"])
)
