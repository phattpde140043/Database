...
source_table = "bronze_erp.accounts"
target_table = "silver_database.accounts"
...
merge_builder = (silver_table.alias("target").merge(bronze_dedup_df.alias("source"),"target."+primary_key+" = source."+primary_key)\
 .whenMatchedUpdate(
    ...
    set={
        ...
        "account_name":col("source.account_name"),
        "account_type":col("source.account_type"),
 ...
 .whenNotMatchedInsert(
     values={
        ...
        concat_ws(
            ...
            coalesce(col("source.account_name"), lit("")),
            coalesce(col("source.account_type"), lit("")),
