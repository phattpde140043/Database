...
source_table = "bronze_erp.purchase_orders"
target_table = "silver_database.purchase_orders"
primary_key = "po_id"
...
merge_builder = (silver_table.alias("target").merge(bronze_dedup_df.alias("source"),"target."+primary_key+" = source."+primary_key)\
 .whenMatchedUpdate(
    ...
    set={
        ...
        "supplier_id":col("source.supplier_id"),
 ...
 .whenNotMatchedInsert(
     values={
        ...
        concat_ws(
            ...
            coalesce(col("source.supplier_id").cast("string"), lit("")),
