...
source_table = "bronze_pos.audit_log"
...
merge_builder = (silver_table.alias("target").merge(bronze_dedup_df.alias("source"),"target."+primary_key+" = source."+primary_key+" AND target.database_source = 'Pos'")\
 .whenMatchedUpdate(
