...
source_table = "bronze_pos.products_sku"
target_table = "silver_database.products_sku"
primary_key = "sku_id"
 ...
 .whenNotMatchedInsert(
     values={
        ...
        concat_ws(
            ...
            coalesce(col("source.sku"), lit("")),
            coalesce(col("source.product_id"), lit("")),
            coalesce(col("source.color"), lit("")),
            coalesce(col("source.size"), lit("")),
            coalesce(col("source.price").cast("string"), lit("")),
