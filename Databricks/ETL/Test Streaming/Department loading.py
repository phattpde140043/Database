...
topic = "erpdbserver.public.departments"
checkpoint_dir = "/path/to/checkpoint"
destination_table ="bronze_erp.departments"
...
df_customers = df_json.filter(col("data.payload.op").isin("r", "c", "u")).select(
    ...
    sha2(
        concat_ws(
            "|",
            coalesce(col("data.payload.after.department_id"), lit("")),
...
df_deduplicated = df_customers \
    ...
    .dropDuplicates(["department_id", "hash"])
